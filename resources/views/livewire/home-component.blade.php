				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">${{$sproduct->sale_price}}</p></ins><del><p class="product-price">${{$sproduct->reqular_price}}</p></del></div>
						</div>
					</div>				
					@endforeach
				</div>
									...
									@foreach($lproducts as $lproduct)
										<div class="product product-style-2 equal-elem ">
											...
											<div class="product-info">
												...
												<div class="wrap-price"><span class="product-price">${{$lproduct->reqular_price}}</span></div>
											</div>
										</div>
									@endforeach								
								</div>
			...
			<div class="wrap-show-advance-info-box style-1">
				...
				<div class="wrap-products">
					<div class="wrap-product-tab tab-style-1">
						...
						<div class="tab-contents">	<!-- فيديو رقم 23 -->	
							@foreach($categories as $key=>$category)				
											...
											@foreach($c_products as $c_product)
												<div class="product product-style-2 equal-elem ">
													...
													<div class="product-info">
														...
														<div class="wrap-price"><span class="product-price">${{$c_product->reqular_price}}</span></div>
													</div>
												</div>
											@endforeach														
									</div>
